...
export default function UploadDialog({
	...
	return (
		<Dialog>
			...
			<DialogContent className="h-[90vh] w-[90vw] max-w-screen-xl">
				<Tabs defaultValue="media" className="relative h-full overflow-hidden">
					...
					<TabsContent value="media" className="h-[calc(100%-3rem)]">
						<div className="grid h-full grid-rows-[auto_1fr] overflow-y-auto pb-10">
							<DialogHeader className="mb-4 h-fit w-fit">
								<DialogTitle className="text-xl font-bold sm:text-2xl">
									My Media
								</DialogTitle>
							</DialogHeader>
							<div className="flex flex-col gap-4 md:grid md:grid-cols-[3fr_1fr]">
